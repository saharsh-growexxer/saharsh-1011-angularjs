...
describe('core/utils', function () {
  describe('generateFileID', function () {
    it('should take the filename object and produce a lowercase file id made up of uppy- prefix, file name (cleaned up to be lowercase, letters and numbers only), type, size and lastModified date', function () {
      ...
      expect(_Utils2.default.generateFileID(fileObj)).toEqual('uppy-foo0fijpg-image/jpeg-2271173-1498510508000');
    });
  });
  ...
  describe('toArray', function () {
    it('should convert a array-like object into an array', function () {
      ...
      expect(_Utils2.default.toArray(obj)).toEqual(['zero', 'one', 'two', 'three', 'four']);
    });
  });

  describe('runPromiseSequence', function () {
    it('should run an array of promise-returning functions in sequence', function () {
      var promiseFn1 = jest.fn().mockReturnValue(Promise.resolve);
      var promiseFn2 = jest.fn().mockReturnValue(Promise.resolve);
      var promiseFn3 = jest.fn().mockReturnValue(Promise.resolve);
      return _Utils2.default.runPromiseSequence([promiseFn1, promiseFn2, promiseFn3]).then(function () {
  ...
  describe('supportsMediaRecorder', function () {
    it('should return true if MediaRecorder is supported', function () {
      ...
      expect(_Utils2.default.supportsMediaRecorder()).toEqual(true);
    });

    it('should return false if MediaRecorder is not supported', function () {
      global.MediaRecorder = undefined;
      expect(_Utils2.default.supportsMediaRecorder()).toEqual(false);
  ...
  describe('isTouchDevice', function () {
    ...
    xit("should return true if it's a touch device", function () {
      expect(_Utils2.default.isTouchDevice()).toEqual(true);
      delete global.window.ontouchstart;
      global.navigator.maxTouchPoints = false;
      expect(_Utils2.default.isTouchDevice()).toEqual(false);
    });
  });

  describe('getFileNameAndExtension', function () {
    it('should return the filename and extension as an array', function () {
      expect(_Utils2.default.getFileNameAndExtension('fsdfjodsuf23rfw.jpg')).toEqual(['fsdfjodsuf23rfw', 'jpg']);
    });

    it('should handle invalid filenames', function () {
      expect(_Utils2.default.getFileNameAndExtension('fsdfjodsuf23rfw')).toEqual(['fsdfjodsuf23rfw', undefined]);
    });
  });

  describe('truncateString', function () {
    it('should truncate the string by the specified amount', function () {
      expect(_Utils2.default.truncateString('abcdefghijkl', 10)).toEqual('abcde...jkl');
      expect(_Utils2.default.truncateString('abcdefghijkl', 9)).toEqual('abcd...jkl');
      expect(_Utils2.default.truncateString('abcdefghijkl', 8)).toEqual('abcd...kl');
      expect(_Utils2.default.truncateString('abcdefghijkl', 7)).toEqual('abc...kl');
      expect(_Utils2.default.truncateString('abcdefghijkl', 6)).toEqual('abc...kl');
      expect(_Utils2.default.truncateString('abcdefghijkl', 5)).toEqual('ab...kl');
      expect(_Utils2.default.truncateString('abcdefghijkl', 4)).toEqual('ab...l');
      expect(_Utils2.default.truncateString('abcdefghijkl', 3)).toEqual('a...l');
      expect(_Utils2.default.truncateString('abcdefghijkl', 2)).toEqual('a...l');
      expect(_Utils2.default.truncateString('abcdefghijkl', 1)).toEqual('...l');
    });
  });

  describe('secondsToTime', function () {
    expect(_Utils2.default.secondsToTime(60)).toEqual({
      hours: 0,
      minutes: 1,
      seconds: 0
    });

    expect(_Utils2.default.secondsToTime(123)).toEqual({
      hours: 0,
      minutes: 2,
      seconds: 3
    });

    expect(_Utils2.default.secondsToTime(1060)).toEqual({
      hours: 0,
      minutes: 17,
      seconds: 40
    });

    expect(_Utils2.default.secondsToTime(123453460)).toEqual({
      hours: 20,
      minutes: 37,
      seconds: 40
    });
  ...
  describe('getFileTypeExtension', function () {
    it('should return the filetype based on the specified mime type', function () {
      expect(_Utils2.default.getFileTypeExtension('video/ogg')).toEqual('ogv');
      expect(_Utils2.default.getFileTypeExtension('audio/ogg')).toEqual('ogg');
      expect(_Utils2.default.getFileTypeExtension('video/webm')).toEqual('webm');
      expect(_Utils2.default.getFileTypeExtension('audio/webm')).toEqual('webm');
      expect(_Utils2.default.getFileTypeExtension('video/mp4')).toEqual('mp4');
      expect(_Utils2.default.getFileTypeExtension('audio/mp3')).toEqual('mp3');
      expect(_Utils2.default.getFileTypeExtension('foo/bar')).toEqual(null);
    });
  });
  ...
  describe('getFileType', function () {
    ...
    it('should trust the filetype if the file comes from a remote source', function () {
      ...
      return _Utils2.default.getFileType(file).then(function (r) {
  ...
  describe('getArrayBuffer', function () {
    ...
    it('should return a promise that resolves with the specified chunk', function () {
      return _Utils2.default.getArrayBuffer('abcde').then(function (buffer) {
  ...
  describe('isPreviewSupported', function () {
    it('should return true for any filetypes that browsers can preview', function () {
      var supported = ['jpeg', 'gif', 'png', 'svg', 'svg+xml', 'bmp'];
      supported.forEach(function (ext) {
        expect(_Utils2.default.isPreviewSupported(ext)).toEqual(true);
      });
      expect(_Utils2.default.isPreviewSupported('foo')).toEqual(false);
    });
  });

  describe('isObjectURL', function () {
    it('should return true if the specified url is an object url', function () {
      expect(_Utils2.default.isObjectURL('blob:abc123')).toEqual(true);
      expect(_Utils2.default.isObjectURL('kblob:abc123')).toEqual(false);
      expect(_Utils2.default.isObjectURL('blob-abc123')).toEqual(false);
      expect(_Utils2.default.isObjectURL('abc123')).toEqual(false);
    });
  });

  describe('createThumbnail', function () {
    xit('should create a thumbnail of the specified image at the specified width', function () {});
  });

  describe('dataURItoBlob', function () {
    it('should convert a data uri to a blob', function () {
      var blob = _Utils2.default.dataURItoBlob(sampleImageDataURI, {});
  ...
  describe('dataURItoFile', function () {
    it('should convert a data uri to a file', function () {
      var file = _Utils2.default.dataURItoFile(sampleImageDataURI, { name: 'foo.jpg' });
  ...
  describe('getSpeed', function () {
    it('should calculate the speed given a fileProgress object', function () {
      ...
      expect(Math.round(_Utils2.default.getSpeed(fileProgress))).toEqual(Math.round(205));
    });
  });
  ...
  describe('getBytesRemaining', function () {
    it('should calculate the bytes remaining given a fileProgress object', function () {
      ...
      expect(_Utils2.default.getBytesRemaining(fileProgress)).toEqual(2072);
    });
  });
  ...
  describe('getETA', function () {
    it('should get the ETA remaining based on a fileProgress object', function () {
      ...
      expect(_Utils2.default.getETA(fileProgress)).toEqual(10.1);
    });
  });

  describe('prettyETA', function () {
    it('should convert the specified number of seconds to a pretty ETA', function () {
      expect(_Utils2.default.prettyETA(0)).toEqual('0s');
      expect(_Utils2.default.prettyETA(1.2)).toEqual('1s');
      expect(_Utils2.default.prettyETA(1)).toEqual('1s');
      expect(_Utils2.default.prettyETA(103)).toEqual('1m 43s');
      expect(_Utils2.default.prettyETA(1034.9)).toEqual('17m 14s');
      expect(_Utils2.default.prettyETA(103984.1)).toEqual('4h 53m 04s');
    });
  });
  ...
  describe('getSocketHost', function () {
    it('should get the host from the specified url', function () {
      expect(_Utils2.default.getSocketHost('https://foo.bar/a/b/cd?e=fghi&l=k&m=n')).toEqual('ws://foo.bar/a/b/cd?e=fghi&l=k&m=n');
    });
  });

  describe('settle', function () {
    it('should reject if all input promises reject', function () {
      return expect(_Utils2.default.settle([Promise.reject(new Error('oops')), Promise.reject(new Error('this went wrong'))])).rejects.toMatchObject({
        message: 'oops'
      });
    });

    it('should resolve with an object if some input promises resolve', function () {
      return expect(_Utils2.default.settle([Promise.reject(new Error('rejected')), Promise.resolve('resolved'), Promise.resolve('also-resolved')])).resolves.toMatchObject({
