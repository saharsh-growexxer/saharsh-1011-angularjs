...
var _Plugin = require('../../src/plugins/Plugin');
...
describe('src/Core', function () {
  ...
  describe('preprocessors', function () {
    ...
    it('should update the file progress state when core:preprocess-progress event is fired', function () {
      var core = new _Core2.default();
      core.run();
      return core.addFile({
        source: 'jest',
    ...
    it('should update the file progress state when core:preprocess-complete event is fired', function () {
      var core = new _Core2.default();
      core.run();
      return core.addFile({
        source: 'jest',
  ...
  describe('postprocessors', function () {
    ...
    it('should update the file progress state when core:postprocess-progress event is fired', function () {
      var core = new _Core2.default();
      core.run();
      return core.addFile({
        source: 'jest',
    ...
    it('should update the file progress state when core:postprocess-complete event is fired', function () {
      var core = new _Core2.default();
      core.run();
      return core.addFile({
        source: 'jest',
  ...
  describe('meta data', function () {
    ...
    it('should update meta data for a file by calling core:update-meta', function () {
      var core = new _Core2.default();
      core.run();
      return core.addFile({
        source: 'jest',
  ...
  describe('checkRestrictions', function () {
    it('should enforce the maxNumberOfFiles rule', function () {
      ...
      return expect(core.addFile({
        ...
        type: 'image/jpg',
        data: _Utils2.default.dataURItoFile(sampleImageDataURI, {})
      })).rejects.toMatchObject({ message: 'File not allowed' }).then(function () {
  ...
  describe('actions', function () {
    it('should update the state when receiving the core:error event', function () {
      var core = new _Core2.default();
      core.run();
    ...
    it('should update the state when receiving the core:upload-error event', function () {
      var core = new _Core2.default();
      core.run();
    ...
    it('should reset the error state when receiving the core:upload event', function () {
      var core = new _Core2.default();
      core.run();
      core.emit('core:error', { foo: 'bar' });
  ...
  describe('removeUpload', function () {
    it('should remove all files from the specified upload', function () {
      // this uploader will run once the upload has started
      var uploader = function uploader() {
        return Promise.resolve().then(function () {
          var uploadId = Object.keys(core.state.currentUploads)[0];
          expect(_typeof(core.state.currentUploads[uploadId])).toEqual('object');
          expect(core.state.currentUploads[uploadId].fileIDs.length).toEqual(1);
          core.removeUpload(uploadId);
          expect(_typeof(core.state.currentUploads[uploadId])).toEqual('undefined');
        });
      };
