...
.UppyDashboardContent-panel {
  ...
  .UppyDashboard--wide .UppyDashboardContent-panel {
    padding-top: 50px; }
  .UppyDashboard--modal .UppyDashboardContent-panel {
    z-index: 1003; }
...
.UppyDashboardItem.is-error .UppyDashboardItem-progressBtn {
  width: 18px;
  height: 18px; }
  .UppyDashboard--wide .UppyDashboardItem.is-error .UppyDashboardItem-progressBtn {
    width: 28px;
    height: 28px; }
...
.UppyDashboardItem.is-error .retry {
  fill: #fff; }
